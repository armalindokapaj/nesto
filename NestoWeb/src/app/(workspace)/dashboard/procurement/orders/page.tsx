...
export default async function ProcurementOrdersPage() {
  ...
  const committed = orders.filter((o) => !["DRAFT", "CANCELLED", "ARCHIVED"].includes(o.status)).reduce((sum, o) => sum + o.amountMinor, 0);
