...
export default async function AnalyticsOverviewPage() {
  ...
  const tiles = [
    ...
    ...(overview.finance ? [{ label: t("analytics.budgetVariance"), value: formatMinorWhole(overview.finance.totalActualMinor - overview.finance.totalBudgetMinor), tone: overview.finance.totalActualMinor >= overview.finance.totalBudgetMinor ? "text-success" : "text-warning" }] : []),
    ...(overview.hr ? [{ label: t("analytics.headcount"), value: overview.hr.headcount, tone: "text-ink" }] : []),
    ...(overview.procurement ? [{ label: t("analytics.committedSpend"), value: formatMinorWhole(overview.procurement.committedSpendMinor), tone: "text-ink" }] : []),
